...
const BoardListCom = ({ Info: infoFromProps }) => {
  ...
  const fetchBoardList = async () => {
    ...
    try {
      const response = await axios.get(
        `http://54.116.0.74:8080/${requestUrl}`,
        {
  ...
  const exitGroup = async () => {
    ...
    try {
      const response = await axios.post(
        `http://54.116.0.74:8080/planbee/groups/${thisGroupId}/leave`,
        {},
        {
          withCredentials: true,
        }
  ...
  const fetchLatestBoard = async () => {
    ...
    try {
      const response = await axios.get(
        `http://54.116.0.74:8080/planbee/groups/${thisGroupId}/boards?sort=newest`,
        { withCredentials: true }
      );
  ...
  const fetchOldestBoard = async () => {
    ...
    try {
      const response = await axios.get(
        `http://54.116.0.74:8080/planbee/groups/${thisGroupId}/boards?sort=oldest`,
        { withCredentials: true }
      );
  ...
  const fetchMaxHitBoard = async () => {
    ...
    try {
      const response = await axios.get(
        `http://54.116.0.74:8080/planbee/groups/${thisGroupId}/boards?sort=hit`,
        { withCredentials: true }
      );
  ...
  const fetchSearchedBoard = async () => {
    ...
    try {
      const response = await axios.get(
        `http://54.116.0.74:8080/planbee/groups/${thisGroupId}/boards?searchType=${searchType}&query=${searchTerm}`,
        { withCredentials: true }
      );
