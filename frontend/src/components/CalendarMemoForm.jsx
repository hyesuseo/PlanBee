...
const CalendarMemoForm = ({
    ...
    const getUserId = async () => {
      try {
        const response = await axios.get(
          `httpp://54.116.0.74:8080/planbee/auth/getUserId`,
          {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `http://54.116.0.74:8080/planbee/calendar/addmemo/${calDate}`,
        requestData,
        { withCredentials: true }
      );
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://54.116.0.74:8080/planbee/calendar/modimemo/${calId}`,
        requestData,
        { withCredentials: true }
      );
  ...
  const handleDelete = async (fieldNo) => {
    ...
    try {
      await axios.delete(
        `http://54.116.0.74:8080/planbee/calendar/delmemo/${calId}/${fieldNo}`,
        { withCredentials: true }
      );
