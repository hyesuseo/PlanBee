...
const BoardWriteCom = () => {
    ...
    if (!selectedProgress || selectedProgress == null) {
      try {
        const response = await axios.post(
          `https://43.200.100.158:8080/planbee/groups/${thisGroupId}/boards`,
          {
            postTitle: postTitle,
      ...
      //progress 체크박스가 활성화된 경우
      switch (selectedProgress) {
        case "daily":
          try {
            const response = await axios.post(
              `https://43.200.100.158:8080/planbee/groups/${thisGroupId}/boards/daily`,
              {},
              {
                withCredentials: true,
              }
        ...
        case "weekly":
          try {
            const response = await axios.post(
              `https://43.200.100.158:8080/planbee/groups/${thisGroupId}/boards/weekly`,
              {},
              {
                withCredentials: true,
              }
  ...
  const handleMonthlyWinner = async () => {
    //월간 등수 자동 글쓰기기
    try {
      const response = await axios.post(
        `https://43.200.100.158:8080/planbee/groups/auto-post/${thisGroupId}`,
        {
          withCredentials: true,
        }
      );
              ...
              <>
                ...
                <div className="post_writeform">
                  ...
                  <button
                    ...
                    className="progress-button-writeform"
                  >
                    진척도 가져오기
                  </button>
                  <button
            ...
            {showProgress && (
              <>
                ...
                <div className="progress_container">
                  {/* 오늘의 진척도 */}
                  <div
                    className="progress_box_writeform"
                    style={{ position: "relative" }}
                  >
                    <input
                      type="checkbox"
                      className="progress_checkbox"
                  ...
                  {/* 주간 진척도 */}
                  <div
                    className="weekly_progress_box_writeform"
                    style={{ position: "relative" }}
                  >
                    <input
                      type="checkbox"
                    ...
                    <div className="weekly_progress_list">
                      <div className="weekly_progress_item">
                        ...
                        <div className="progress_bar_outer">
                          <div
                            className="progress_bar_inner red"
                            style={{ width: "20%" }}
                          >
                            20%
                          </div>
                      ...
                      <div className="weekly_progress_item">
                        ...
                        <div className="progress_bar_outer">
                          <div
                            className="progress_bar_inner yellow"
                            style={{ width: "45%" }}
                          >
                            45%
                          </div>
                      ...
                      <div className="weekly_progress_item">
                        ...
                        <div className="progress_bar_outer">
                          <div
                            className="progress_bar_inner green"
                            style={{ width: "75%" }}
                          >
                            75%
                          </div>
                ...
                <div className="button_container_writeform">
                  <button
                    ...
                    className="close_button_writeform"
                  >
                    닫기
                  </button>
                  <button
                    onClick={() => handleAddPost()}
                    className="post_button_writeform"
                  >
                    Post
                  </button>
                </div>
